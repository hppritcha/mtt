...
rm -f -r /cray/css/users/n17276/mtt_tiger_short_v3.x_tmp
timeout 170m client/mtt --file ompi-tiger-nightly-v3.x.ini --mpi-get --mpi-install --test-get --test-build --test-run --verbose
...
timeout 170m client/mtt --file ompi-tiger-nightly-v2.0.x.ini --mpi-get --mpi-install --test-get --test-build --test-run --verbose
